...
/// </summary>
public interface ICSharpKeywordCodeGenerator
{
    /// <summary>
    ...
    string GenerateCode(CSharpCodeGenerationContext context);

    /// <summary>
    /// Returns any static field declarations needed (e.g., compiled Regex).
    /// </summary>
    IEnumerable<StaticFieldInfo> GetStaticFields(CSharpCodeGenerationContext context);
}
...
/// </summary>
public sealed class CSharpCodeGenerationContext
{
    /// <summary>
    ...
    /// Populated during code generation, consumed by CSharpSchemaCodeGenerator for field generation.
    /// </summary>
