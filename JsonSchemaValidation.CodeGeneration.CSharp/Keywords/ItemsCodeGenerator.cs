...
/// </summary>
public sealed class ItemsCodeGenerator : ICSharpKeywordCodeGenerator
{
    ...
    /// </summary>
    private string GenerateDraft202012Items(CSharpCodeGenerationContext context, JsonElement itemsElement)
    {
    ...
    /// </summary>
    private string GenerateLegacyItems(CSharpCodeGenerationContext context, JsonElement itemsElement)
    {
        var e = context.ElementVariable;
        var eval = context.EvaluatedStateVariable;
        var loc = context.LocationVariable;
    ...
    /// </summary>
    private string GenerateTupleItems(CSharpCodeGenerationContext context, JsonElement itemsElement)
    {
        var e = context.ElementVariable;
        var eval = context.EvaluatedStateVariable;
        var loc = context.LocationVariable;
...
/// </summary>
public sealed class PrefixItemsCodeGenerator : ICSharpKeywordCodeGenerator
{
...
/// </summary>
public sealed class AdditionalItemsCodeGenerator : ICSharpKeywordCodeGenerator
{
