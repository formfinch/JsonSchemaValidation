...
namespace JsonSchemaValidation.Draft202012
{
    public static class SchemaDraft202012Setup
    {
        public static IServiceCollection AddDraft202012(this IServiceCollection services)
        {
            ...
            services.AddSingleton<ISchemaDraftKeywordValidatorFactory, ContentEncodingValidatorFactory>();
            services.AddSingleton<ISchemaDraftKeywordValidatorFactory, ContentMediaTypeValidatorFactory>();
            services.AddSingleton<ISchemaDraftKeywordValidatorFactory, ContentSchemaValidatorFactory>();
            ...
            services.AddSingleton<ISchemaDraftKeywordValidatorFactory, RefValidatorFactory>();
            ...
            services.AddSingleton<ISchemaDraftKeywordValidatorFactory, PropertyNamesValidatorFactory>();
