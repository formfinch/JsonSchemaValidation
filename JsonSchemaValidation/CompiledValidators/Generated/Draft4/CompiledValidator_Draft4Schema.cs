...
namespace FormFinch.JsonSchemaValidation.CompiledValidators.Generated
{
    public sealed class CompiledValidator_Draft4Schema : ICompiledValidator
    {
        ...
        public bool IsValid(JsonElement instance) => Validate_b23e46eac88c(instance);

    private static bool Validate_b23e46eac88c(JsonElement e)
    {
    ...
    {
        // $ref: #
        if (!Validate_b23e46eac88c(e)) return false;
        return true;
    }
