...
namespace JsonSchemaValidation.CompiledValidators.Generated
{
    ...
    private static bool Validate_5b979b5c4e9c(JsonElement e)
    {
        ...
        if (e.ValueKind == JsonValueKind.Object)
        {
            ...
            {
                if (!Validate_00404e686415(_id_)) return false;
            }
            if (e.TryGetProperty("$schema", out var __schema_))
            {
                if (!Validate_00404e686415(__schema_)) return false;
            }
            ...
            {
                if (!Validate_9b9a9f6bbfc3(_multipleOf_)) return false;
            }
            ...
            {
                if (!Validate_45f783c5cbd2(_maxLength_)) return false;
            }
            if (e.TryGetProperty("minLength", out var _minLength_))
            {
                if (!Validate_e4767d88c656(_minLength_)) return false;
            }
            ...
            {
                if (!Validate_e586d25b0b31(_additionalItems_)) return false;
            }
            ...
            {
                if (!Validate_45f783c5cbd2(_maxItems_)) return false;
            }
            if (e.TryGetProperty("minItems", out var _minItems_))
            {
                if (!Validate_e4767d88c656(_minItems_)) return false;
            }
            ...
            {
                if (!Validate_45f783c5cbd2(_maxProperties_)) return false;
            }
            if (e.TryGetProperty("minProperties", out var _minProperties_))
            {
                if (!Validate_e4767d88c656(_minProperties_)) return false;
            }
            ...
            {
                if (!Validate_e586d25b0b31(_additionalProperties_)) return false;
            }
    ...
    {
        // $ref: #
        if (!Validate_5b979b5c4e9c(e)) return false;
        return true;
    }
