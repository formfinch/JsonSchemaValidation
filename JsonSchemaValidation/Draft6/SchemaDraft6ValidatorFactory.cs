...
{
    internal class SchemaDraft6ValidatorFactory : ISchemaDraftValidatorFactory
    {
        private readonly ISchemaDraftKeywordValidatorFactory[] _keywordFactories;

        public string DraftVersion => SchemaDraft6Setup.DraftVersion;

        public SchemaDraft6ValidatorFactory(
            [FromKeyedServices(SchemaDraft6Setup.DraftVersion)] IEnumerable<ISchemaDraftKeywordValidatorFactory> keywordFactories)
        {
        ...
        public ISchemaValidator CreateValidator(SchemaMetadata schemaData)
        {
            ...
            // Draft 6 special case: when $ref is present, ALL sibling keywords are ignored.
