...
/// Draft 2019-09 supports: date-time, date, time, duration, email, idn-email, hostname, idn-hostname,
/// ipv4, ipv6, uri, uri-reference, uri-template, iri, iri-reference, json-pointer, relative-json-pointer, regex, uuid.
/// </summary>
