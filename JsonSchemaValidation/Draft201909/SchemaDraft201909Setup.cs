...
using JsonSchemaValidation.Draft201909.Keywords;
using Microsoft.Extensions.DependencyInjection;

namespace JsonSchemaValidation.Draft201909
{
    public static class SchemaDraft201909Setup
    {
        /// <summary>
        /// The draft version key used for keyed service registration.
        /// </summary>
        public const string DraftVersion = "https://json-schema.org/draft/2019-09/schema";

        public static IServiceCollection AddDraft201909(this IServiceCollection services)
        {
            // Vocabulary support (each parser owns its own registry)
            services.AddSingleton<IVocabularyParser, VocabularyParser>();

            services.AddSingleton<ISchemaDraftMeta, SchemaDraft201909Meta>();
            services.AddSingleton<ISchemaDraftValidatorFactory, SchemaDraft201909ValidatorFactory>();
            ...
            services.AddKeyedSingleton<ISchemaDraftKeywordValidatorFactory, RecursiveRefValidatorFactory>(DraftVersion);
