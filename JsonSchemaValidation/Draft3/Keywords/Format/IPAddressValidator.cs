...
// Validates ip-address (IPv4) and ipv6 formats.
// Note: Draft 3 uses "ip-address" instead of "ipv4".
...
namespace FormFinch.JsonSchemaValidation.Draft3.Keywords.Format
{
    internal sealed class IPAddressValidator : IKeywordValidator
    {
        ...
        public IPAddressValidator(bool isIPV6Format = false)
        {
            ...
            // Draft 3 uses "ip-address" for IPv4, not "ipv4"
            _formatName = isIPV6Format ? "ipv6" : "ip-address";
        }
