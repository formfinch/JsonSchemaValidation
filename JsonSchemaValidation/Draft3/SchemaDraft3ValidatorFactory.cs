...
namespace JsonSchemaValidation.Draft3
{
    public class SchemaDraft3ValidatorFactory : ISchemaDraftValidatorFactory
    {
        private readonly ISchemaDraftKeywordValidatorFactory[] _keywordFactories;

        public string DraftVersion => SchemaDraft3Setup.DraftVersion;

        public SchemaDraft3ValidatorFactory(
            [FromKeyedServices(SchemaDraft3Setup.DraftVersion)] IEnumerable<ISchemaDraftKeywordValidatorFactory> keywordFactories)
        {
        ...
        public ISchemaValidator CreateValidator(SchemaMetadata schemaData)
        {
            ...
            // Draft 3 special case: when $ref is present, ALL sibling keywords are ignored.
