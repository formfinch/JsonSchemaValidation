...
{
    public sealed class CompiledValidator_Draft202012MetaValidation : ICompiledValidator
    {
        ...
        public bool IsValid(JsonElement instance) => Validate_a7932f0f4184(instance);

    private static bool Validate_a7932f0f4184(JsonElement e)
    {
        {
